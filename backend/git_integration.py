...
def init_git_repo(workspace_dir: str):
    ...
    subprocess.run(['git', 'config', 'user.email', 'candidate@oaiaw.com'], cwd=workspace_dir, check=False)
    subprocess.run(['git', 'config', 'user.name', 'Candidate'], cwd=workspace_dir, check=False)
